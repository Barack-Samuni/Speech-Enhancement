...
final_sig = sig + noise
file_add = r"C:\Users\Omer\Documents\Projects\WAVS\ANC WAVS"
sf.write(file_add + r"\total_sig.wav", final_sig, fs1)
sf.write(file_add + r"\processed_sig.wav", sig, fs1)
sf.write(file_add + r"\processed_noise.wav", noise, fs1)
print("Succsseeded")
